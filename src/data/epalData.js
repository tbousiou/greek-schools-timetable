                    ...
                    specialties: [
                        {
                            ...
                            subjects: [
                                ...
                                { name: "Δενδροκομία - Αμπελουργία", hours: 5 },
                                { name: "Φυτά Μεγάλης Καλλιέργειας", hours: 4 },
                                { name: "Κηπευτικές Καλλιέργειες - Αρδεύσεις", hours: 5 },
                        ...
                        },
                        {
                            ...
                            subjects: [
                                ...
                                { name: "Εκτροφή Αγροτικών Ζώων", hours: 6 },
                                { name: "Υδατοκαλλιέργειες", hours: 4 },
                        ...
                        },
                        {
                            ...
                            subjects: [
                                ...
                                { name: "Μεταποίηση Φυτικών Προϊόντων", hours: 5 },
                                { name: "Μεταποίηση Ζωικών Προϊόντων", hours: 5 },
                                { name: "Ασφάλεια Τροφίμων", hours: 3 },
                            ]
                        },
                        {
                    ...
                    specialties: [
                        {
                            ...
                            subjects: [
                                ...
                                { name: "Σύγχρονο Περιβάλλον Γραφείου", hours: 4 },
                                { name: "Φορολογική Πρακτική", hours: 6 },
                                { name: "Λογιστικές Εφαρμογές", hours: 5 },
                        ...
                        },
                        {
                            ...
                            subjects: [
                                { name: "Αρχές Οικονομικής Θεωρίας", hours: 3 },
                                { name: "Αρχές Οργάνωσης και Διοίκησης", hours: 3 },
                                { name: "Οργάνωση και Λειτουργία Τουριστικών Επιχειρήσεων", hours: 4 },
                                { name: "Οργάνωση και Λειτουργία Ξενοδοχειακών Επιχειρήσεων", hours: 4 },
                                { name: "Γεωγραφία Τουρισμού", hours: 2 },
                                { name: "Εφαρμογές στον Τουρισμό", hours: 3 },
                        ...
                        },
                        {
                            ...
                            subjects: [
                                ...
                                { name: "Αρχές Οργάνωσης και Διοίκησης", hours: 3 },
                                { name: "Σύγχρονο Περιβάλλον Γραφείου", hours: 4 },
                                { name: "Διαφήμιση (Εισαγωγή, Δημιουργία και Προβολή)", hours: 6 },
                                { name: "Επικοινωνία και Δημόσιες Σχέσεις", hours: 2 },
                        ...
                        },
                        {
                            ...
                            subjects: [
                                { name: "Αρχές Οικονομικής Θεωρίας", hours: 3 },
                                { name: "Αρχές Οργάνωσης και Διοίκησης", hours: 3 },
                                { name: "Οργάνωση και Διαχείριση Αποθηκών", hours: 5 },
                                { name: "Οργάνωση και Διαχείριση Μεταφορών", hours: 4 },
                                { name: "Εφαρμογές Εφοδιαστικής", hours: 6 },
                                { name: "Λογιστικές Εφαρμογές", hours: 2 },
                            ]
                        },
                    ],
                    ...
                    specialties: [
                        {
                            ...
                            subjects: [
                                ...
                                { name: "Εφαρμογές Γεωπληροφορικής στα Τεχνικά Έργα", hours: 5 },
                                { name: "Οργάνωση Τεχνικών Έργων", hours: 4 },
                                { name: "Σχέδιο Δομικών Έργων με χρήση Η/Υ ΙΙ", hours: 4 },
                            ]
                        },
                    ],
                },
                    ...
                    specialties: [
                        {
                            ...
                            subjects: [
                                ...
                                { name: "Γραφιστικές Εφαρμογές", hours: 4 },
                                { name: "Τεχνολογία Εκτυπώσεων", hours: 4 },
                                { name: "Ψηφιακή Σχεδίαση Εντύπων", hours: 4 },
                        ...
                        },
                        {
                            ...
                            subjects: [
                                { name: "Ιστορία Σύγχρονης Τέχνης", hours: 3 },
                                { name: "Τεχνολογία Υλικών", hours: 2 },
                                { name: "Εργαστήριο Χειροποίητου Κοσμήματος", hours: 9 },
                        ...
                        },
                        {
                            ...
                            subjects: [
                                { name: "Ιστορία Σύγχρονης Τέχνης", hours: 3 },
                                { name: "Τεχνολογία Υλικών", hours: 2 },
                                { name: "Βασικές Τεχνικές Συντήρησης Έργων Τέχνης", hours: 7 },
                                { name: "Προστασία Πολιτιστικής Κληρονομιάς", hours: 2 },
                                { name: "Αντίγραφο Έργων Τέχνης", hours: 5 },
                        ...
                        },
                        {
                            ...
                            subjects: [
                                { name: "Ιστορία Σύγχρονης Τέχνης", hours: 3 },
                                { name: "Τεχνολογία Υλικών", hours: 2 },
                                { name: "Τεχνολογία Προτύπων Κοπής (Πατρόν)", hours: 5 },
                                { name: "Ηλεκτρονική Σχεδίαση Βιομηχανικού Προϊόντος", hours: 3 },
                                { name: "Τεχνολογία Υφάσματος και Οργάνωση Συλλογής Ενδύματος", hours: 3 },
                                { name: "Ποιοτικός Έλεγχος Υφάσματος", hours: 3 },
                                { name: "Τεχνολογία Παραγωγής Ενδυμάτων", hours: 4 },
                            ]
                        },
                        {
                            ...
                            subjects: [
                                ...
                                { name: "Διακοσμητική Σύνθεση – Τρισδιάστατη Μακέτα", hours: 6 },
                                { name: "Αγγλικά Ειδικότητας", hours: 2 },
                            ]
                        },
                        {
                            ...
                            subjects: [
                                { name: "Ιστορία Σύγχρονης Τέχνης", hours: 3 },
                                { name: "Τεχνολογία Υλικών", hours: 2 },
                                { name: "Ξύλινες Κατασκευές", hours: 6 },
                                { name: "Συνδεσμολογία Επίπλου - Ξυλογλυπτική", hours: 6 },
                                { name: "Τεχνολογία Ξύλου - Μετρήσεις", hours: 2 },
                    ...
                    specialties: [
                        {
                            ...
                            subjects: [
                                ...
                                { name: "Εγκατάσταση και Διαχείριση Δικτύων - Συντήρηση Υπολογιστικών Συστημάτων", hours: 3 },
                                { name: "Συστήματα Ελέγχου και Ασφάλειας", hours: 2 },
                                { name: "Τηλεπικοινωνίες - Τηλεματική", hours: 5 },
                                { name: "Ρομποτική", hours: 3 },
                        ...
                        },
                        {
                            ...
                            subjects: [
                                ...
                                { name: "Ηλεκτρολογικές Εγκαταστάσεις 2", hours: 7 },
                                { name: "Εργαστήριο Ηλεκτροτεχνίας – Ηλεκτρικών Μηχανών", hours: 4 },
                                { name: "Αυτοματισμοί Προγραμματιζόμενης Λογικής", hours: 6 },
                            ]
                        },
                    ],
                },
                    ...
                    specialties: [
                        {
                            ...
                            subjects: [
                                ...
                                { name: "Μηχανουργική Τεχνολογία – Εργαλειομηχανές", hours: 8 },
                                { name: "Ανελκυστήρες – Ανυψωτικές Μηχανές", hours: 2 },
                                { name: "Στοιχεία Ψύξης – Κλιματισμού", hours: 7 },
                            ]
                        },
                        {
                            ...
                            subjects: [
                                { name: "Στοιχεία Μηχανών", hours: 3 },
                                { name: "Στοιχεία Σχεδιασμού Κεντρικών Θερμάνσεων", hours: 3 },
                                { name: "Συντήρηση και Επισκευή Εγκαταστάσεων Καύσης Υγρών και Αερίων Καυσίμων", hours: 5 },
                                { name: "Ύδρευση – Αποχέτευση", hours: 4 },
                                { name: "Κατασκευή και Λειτουργία Κεντρικής Θέρμανσης", hours: 6 },
                        ...
                        },
                        {
                            ...
                            subjects: [
                                ...
                                { name: "Εγκαταστάσεις Κλιματισμού", hours: 7 },
                        ...
                        },
                        {
                            ...
                            subjects: [
                                ...
                                { name: "Μηχανές Εσωτερικής Καύσης ΙΙ (ΕΡΓΑΣΤΗΡΙΟ)", hours: 4 },
                                { name: "Συστήματα Αυτοκινήτου", hours: 7 },
                                { name: "Τεχνολογία Ελέγχων και Διαγνώσεων", hours: 6 },
                            ]
                        },
                        {
                            ...
                            subjects: [
                                ...
                                { name: "Κινητήρες Αεροσκαφών (ΕΡΓΑΣΤΗΡΙΟ)", hours: 4 },
                                { name: "Δομή και Συστήματα Αεροσκαφών", hours: 7 },
                                { name: "Διαδικασίες Συντήρησης Αεροσκαφών", hours: 2 },
                                { name: "Τεχνολογία Αεροπορικού Υλικού", hours: 4 },
                            ]
                        },
                    ],
                },
                    ...
                    specialties: [
                        {
                            ...
                            subjects: [
                                ...
                                { name: "Πληροφοριακά Συστήματα σε Επιχειρήσεις και Οργανισμούς", hours: 2 },
                                { name: "Συστήματα Διαχείρισης Βάσεων Δεδομένων και Εφαρμογές τους στο Διαδίκτυο", hours: 4 },
                                { name: "Ειδικά Θέματα στον Προγραμματισμό Υπολογιστών", hours: 4 },
                        ...
                        },
                        {
                            ...
                            subjects: [
                                ...
                                { name: "Δίκτυα Υπολογιστών (Εργαστήριο)", hours: 2 },
                                { name: "Πληροφοριακά Συστήματα σε Επιχειρήσεις και Οργανισμούς", hours: 2 },
                                { name: "Εγκατάσταση, Διαχείριση και Συντήρηση Υπολογιστικών Συστημάτων", hours: 4 },
                                { name: "Ειδικά Θέματα στο Υλικό και στα Δίκτυα Υπολογιστών", hours: 4 },
                    ...
                    specialties: [
                        ...
                        },
                        {
                            ...
                            subjects: [
                                { name: "Ανατομία-Φυσιολογία ΙΙ", hours: 3 },
                                { name: "Υγιεινή", hours: 2 },
                                { name: "Μικροβιολογία ΙΙ", hours: 5 },
                                { name: "Αιματολογία", hours: 5 },
                        ...
                        },
                        {
                            ...
                            subjects: [
                                { name: "Ανατομία - Φυσιολογία ΙΙ", hours: 3 },
                                { name: "Υγιεινή", hours: 2 },
                                { name: "Παιδαγωγικό Περιβάλλον Βρεφονηπιακού Σταθμού", hours: 4 },
                                { name: "Αγωγή Βρέφους και Νηπίου", hours: 4 },
                                { name: "Στοιχεία Γενικής και Εξελικτικής Ψυχολογίας", hours: 2 },
                                { name: "Δημιουργική Απασχόληση στην Προσχολική Ηλικία ΙΙ", hours: 4 },
                                { name: "Μουσικοκινητική Αγωγή", hours: 2 },
                                { name: "Λογοτεχνία Προσχολικής", hours: 2 },]
                        },
                        {
                            ...
                            subjects: [
                                ...
                                { name: "Φυσικοθεραπεία", hours: 5 },
                                { name: "Πρακτική Φυσικοθεραπεία", hours: 3 },
                                { name: "Μάλαξη", hours: 2 },
                                { name: "Φυσικά Μέσα και Εφαρμογή τους", hours: 5 },
                            ]
                        },
                        {
                            ...
                            subjects: [
                                ...
                                { name: "Ακίνητη Προσθετική", hours: 4 },
                                { name: "Ακίνητη Προσθετική και Πορσελάνη", hours: 6 },
                        ...
                        },
                        {
                            ...
                            subjects: [
                                ...
                                { name: "Νεότερες Απεικονιστικές Μέθοδοι", hours: 3 },
                                { name: "Ακτινοτεχνολογία ΙΙ", hours: 9 },
                        ...
                        },
                        {
                            ...
                            subjects: [
                                ...
                                { name: "Φαρμακολογία - Τοξικολογία", hours: 6 },
                            ]
                        },
                        {
                            ...
                            subjects: [
                                ...
                                { name: "Σύγχρονη Αισθητική ΙΙ", hours: 7 },
                                { name: "Αισθητική Άκρων - Ονυχοπλαστική", hours: 3 },
                                { name: "Κοσμητολογία - Τεχνολογία Υλικών", hours: 2 },
                            ]
                        },
                        {
                            ...
                            subjects: [
                                ...
                                { name: "Εργαστήριο Τεχνικών Εργασιών", hours: 5 },
                                { name: "Καλλιτεχνικά Χτενίσματα", hours: 4 },
                                { name: "Τεχνολογία Υλικών", hours: 2 },
                                { name: "Βασικές Εφαρμογές Κομμωτικής ΙΙ", hours: 5 },
                            ]
                        },
                    ],
                },
