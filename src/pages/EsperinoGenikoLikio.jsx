...
const coreSubjectsB = [
  { name: "Αρχαία Ελληνική Γλώσσα και Γραμματεία", hours: 1 },
  { name: "Νεοελληνική Γλώσσα και Λογοτεχνία", hours: 4 },
...
function EsperinoGenikoLikio() {
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold mb-4">Εσπερινό Γενικό Λύκειο</h1>
      ...
      {/* Economics Orientation Group (centered) */}
...
export default EsperinoGenikoLikio