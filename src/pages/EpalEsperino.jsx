      ...
      {activeTab === 'C' && (
        <section>
          ...
          {selectedSector && (
            <div className="mt-4">
              <h3 className="text-lg font-medium mb-3">
                Μαθήματα Τομέα: {esperinoEPALData.classC.subjects.sectors[selectedSector].name}
              </h3>
              <div className="overflow-x-auto">
                <ClassTable data={esperinoEPALData.classC.subjects.sectors[selectedSector].subjects} />
              </div>
            </div>
          )}
